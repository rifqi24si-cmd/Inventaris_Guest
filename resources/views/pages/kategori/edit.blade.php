...
@section('content')
    <div class="page-heading header-text" style="background-color: #2a2a2a; padding: 100px 0px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3 style="color: #fff;">Edit Kategori Aset</h3>
                    <span class="breadcrumb">
                        ...
                        <span style="color: #eee;"> > Edit: {{ $kategori->nama }} </span>
                    </span>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center mb-4">
                                    <div class="section-heading">
                                        <h6 style="color: #ee626b;">Update Category</h6>
                                        <h2 style="color: #fff;">Perbarui Data Kategori</h2>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset>
                                                ...
                                                <textarea name="deskripsi"
                                                    style="background-color: #3a3a3a; color: #fff; border: 1px solid #444; border-radius: 20px; padding: 12px 20px; width: 100%; margin-bottom: 20px; height: 120px;">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
                                            </fieldset>
                                        </div>
