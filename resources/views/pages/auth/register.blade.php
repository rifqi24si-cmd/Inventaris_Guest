        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center mb-5">
                    <h6 style="color: #ff511a; font-size: 1.1rem; letter-spacing: 2px; margin-bottom: 15px;">JOIN LUGX GAMING</h6>
                    <h2 style="color: #fff; font-size: 3.5rem; font-weight: 700; margin-bottom: 20px;">CREATE YOUR ACCOUNT</h2>
                    <p style="color: #aaa; font-size: 1.1rem; max-width: 600px; margin: 0 auto 40px;">
                        Join our gaming community today! Get exclusive deals, early access to games, and connect with fellow gamers worldwide.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                <label for="name" class="form-label" style="color: #fff; font-weight: 500; margin-bottom: 8px; display: block;">Full Name</label>
                            ...
                            <!-- Confirm Password -->
                            <div class="col-md-6 mb-4">
                                <label for="password-confirm" class="form-label" style="color: #fff; font-weight: 500; margin-bottom: 8px; display: block;">Confirm Password</label>
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="terms" style="color: #aaa; cursor: pointer;">
                                        I agree to the <a href="#" style="color: #ff511a; text-decoration: none;">Terms & Conditions</a> 
                                        and <a href="#" style="color: #ff511a; text-decoration: none;">Privacy Policy</a>
                                    </label>
                                    @error('terms')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="newsletter" 
                                           ...
                                           style="background-color: transparent; border-color: #ff511a; cursor: pointer;">
                                    <label class="form-check-label" for="newsletter" style="color: #aaa; cursor: pointer;">
                                        Subscribe to newsletter for exclusive gaming deals and updates
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="divider d-flex align-items-center my-4">
                            ...
                            <span class="mx-3" style="color: #aaa; font-size: 0.9rem;">Or sign up with</span>
                            <div class="line" style="flex-grow: 1; height: 1px; background: rgba(255, 255, 255, 0.2);"></div>
                        </div>
                        ...
                        <div class="text-center mt-4 pt-3" style="border-top: 1px solid rgba(255, 255, 255, 0.1);">
                            <p style="color: #aaa; margin-bottom: 5px;">Already have an account?</p>
