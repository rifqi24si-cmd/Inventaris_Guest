...
@section('content')
    <div class="page-heading header-text" style="background-color: #2a2a2a; padding: 100px 0px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3 style="color: #fff;">Edit Log Pemeliharaan</h3>
                    <span class="breadcrumb" style="color: #eee;">Update rincian untuk:
                        {{ $pemeliharaan->aset->nama_aset }}</span>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form action="{{ route('pemeliharaan.update', $pemeliharaan->pemeliharaan_id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center mb-4">
                                    <h6 style="color: #ee626b;">Update Maintenance</h6>
                                    <h2 style="color: #fff;">Perbarui Data</h2>
                                </div>
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <select name="aset_id"
                                        ...
                                        @foreach($asets as $aset)
                                            <option value="{{ $aset->aset_id }}" {{ $pemeliharaan->aset_id == $aset->aset_id ? 'selected' : '' }}>
                                                {{ $aset->nama_aset }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="date" name="tanggal" value="{{ $pemeliharaan->tanggal }}"
                                        style="background-color: #3a3a3a; color: #fff; border: 1px solid #444; border-radius: 20px; padding: 12px 20px; width: 100%;"
                                        required>
                                </div>
                                ...
                                <div class="col-lg-12 mb-3">
                                    <label style="color: #ee626b; font-weight: 600;">Tindakan</label>
                                    <input type="text" name="tindakan" value="{{ $pemeliharaan->tindakan }}"
                                        style="background-color: #3a3a3a; color: #fff; border: 1px solid #444; border-radius: 20px; padding: 12px 20px; width: 100%;"
                                        required>
                                </div>

                                <div class="col-lg-12 mb-3">
                                    <label style="color: #ee626b; font-weight: 600;">Pelaksana</label>
                                    <input type="text" name="pelaksana" value="{{ $pemeliharaan->pelaksana }}"
                                        style="background-color: #3a3a3a; color: #fff; border: 1px solid #444; border-radius: 20px; padding: 12px 20px; width: 100%;"
                                        required>
                                </div>
